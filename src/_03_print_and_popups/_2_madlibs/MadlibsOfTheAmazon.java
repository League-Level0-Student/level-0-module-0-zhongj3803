...
String adjective = JOptionPane.showInputDialog("Please input any adjective");
		// Get the player to enter a type of liquid
String liquid = JOptionPane.showInputDialog("Please input any liquid");

		// Get the player to enter a body part
String bodypart = JOptionPane.showInputDialog("Please input any body part");
		// Get the player to enter a verb
String verb = JOptionPane.showInputDialog("Please input any verb");

		// Get the player to enter a place
String place = JOptionPane.showInputDialog("Please input any place");

		// The story below has been written as a group of Strings joined together by + signs.
